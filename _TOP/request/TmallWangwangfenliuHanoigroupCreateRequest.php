<?php
/**
 * TOP API: tmall.wangwangfenliu.hanoigroup.create request
 *
 * @author auto create
 * @since  1.0, 2013-04-29 16:46:23
 */
class TmallWangwangfenliuHanoigroupCreateRequest {
	...
	public function check() {
		...
		RequestCheckUtil::checkMaxLength($this->hanoiGroupName, 200, "hanoiGroupName");
		...
		RequestCheckUtil::checkMaxLength($this->hanoiLabelName, 200, "hanoiLabelName");
	}
